    ...
    return (
      <div className="form-container">
        ...
        <form className="form-row" onSubmit={this.handleSubmit}>
          ...
          <div className="form-group workout-name-form">
          ...
          <div className="form-group muscle-group-form">
            <label className="muscle-group-label" htmlFor="muscle-group">
              Muscle Group</label>
            <select name="muscle-group" required onChange={this.handleMuscleGroupChange}>
          ...
          <div className="form-group set-form workout-name-form">
          ...
          <div className="form-group  notes-form">
